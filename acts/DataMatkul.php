...
class ControllerDataMatkul extends Controller {
    ...
    {
        $model = new ModelDataMatkul();
        $view = new ViewDataMatkul();
...
class ModelDataMatkul extends Model {
    ...
    public function delete($id = 0) {
        ...
        header("Location:".$app->website."/DataMatkul/index");
    }
    ...
    public function save($id) {
        ...
        header("Location:".$app->website."/DataMatkul/index?message=".implode('<br>', $message));
    }
...
class ViewDataMatkul extends View {
    public function entry($result) {
        global $app;
?>
    <form action="<?php echo $app->website; ?>/DataMatkul/save" method="POST">
...
?>
                    ...
                    <div class="pmd-card-action" style="padding:20px;">
                        ...
                        <a href="<?php echo $app->website; ?>/DataMatkul/index" class="btn pmd-ripple-effect btn-danger"> Batal </a>
                    </div>
                </div>
            </div>
        </div>
