...
class ModelMatkul2011 extends Model {
    ...
    public function save($id) {
        ...
        header("Location:".$app->website."/Matkul2011/index?message=".implode('<br>', $message));
    }
...
class ViewMatkul2011 extends View {
    public function entry($result) {
        global $app;
?>
    <form action="<?php echo $app->website; ?>/Matkul2011/save" method="POST">
...
<div style="margin-top:-70px; margin-bottom:20px;">
    <a class="btn pmd-ripple-effect btn-success" href="<?php echo $app->website; ?>/Matkul2011/entry/0">Tambah</a>
...
?>
                <tr>
                    <td data-title="Aksi">
                        <a href="<?php echo $app->website; ?>/Matkul2011/entry/<?php echo $obj->id; ?>">
