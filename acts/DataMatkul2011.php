...
class ControllerDataMatkul2011 extends Controller {
    ...
    {
        $model = new ModelDataMatkul2011();
        $view = new ViewDataMatkul2011();
...
class ModelDataMatkul2011 extends Model {
    public $id = 0;
    public $username = '';
    public $password = '';
    public $level = '';
    ...
    public function delete($id = 0) {
        ...
        header("Location:".$app->website."/DataMatkul2011/index");
    }
...
class ViewDataMatkul2011 extends View {
