...
class ModelPenggunaAdmin extends Model
{
    ...
    public function save($id)
    {
        ...
        header("Location:" . $app->website . "/PenggunaAdmin/index?message=" . implode('<br>', $message));
    }
...
class ViewPenggunaAdmin extends View
{
    public function entry($result)
    {
        global $app;
        ?>
    <form action="<?php echo $app->website; ?>/PenggunaAdmin/save" method="POST">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                    ...
                    <div class="pmd-card-action" style="padding:20px;">
                        ...
                        <a href="<?php echo $app->website; ?>/PenggunaAdmin/index" class="btn pmd-ripple-effect btn-danger"> Batal </a>
                    </div>
                </div>
            </div>
        </div>
...
public function index($result)
{
    ...
    <div style="margin-top:-70px; margin-bottom:20px;">
        <a class="btn pmd-ripple-effect btn-success" href="<?php echo $app->website; ?>/PenggunaAdmin/entry/0">Tambah</a>
            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach ($result as $obj) {
                        ...
                        <tr>
                            <td data-title="Aksi">
                                <a href="<?php echo $app->website; ?>/PenggunaAdmin/entry/<?php echo $obj->id; ?>">
