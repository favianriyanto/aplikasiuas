...
class ControllerDataKelas extends Controller
{
...
class ModelDataKelas extends Model
{
    ...
    public function delete($id = 0)
    {
        ...
        header("Location:" . $app->website . "/DataKelas/index");
    }
    ...
    public function save($id)
    {
        ...
        header("Location:" . $app->website . "/DataKelas/index?message=" . implode('<br>', $message));
    }
...
class ViewDataKelas extends View
{
    public function entry($result)
    {
        global $app;
        ?>
    <form action="<?php echo $app->website; ?>/DataKelas/save" method="POST">
...
public function index($result)
{
    ...
    <div style="margin-bottom:20px;">
        <a class="btn pmd-ripple-effect btn-success" href="<?php echo $app->website; ?>/DataKelas/entry/0">Tambah</a>
    </div>
                ...
                <tbody>
                    ...
                    foreach ($result as $obj) {
                        ...
                        <tr>
                            ...
                            <!-- <td data-title="DataKelas"><?php echo $obj->kelas; ?></td> -->
