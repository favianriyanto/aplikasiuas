...
class ControllerJadwalAll extends Controller
{
    ...
    {
        $model = new ModelJadwalAll();
        $view = new ViewJadwalAll();
...
class ModelJadwalAll extends Model
{
    public $id = 0;
    public $username = '';
    public $password = '';
    ...
    public function delete($id = 0)
    {
        ...
        header("Location:" . $app->website . "/JadwalAll/index");
    }
    ...
    public function save($id)
    {
        ...
        header("Location:" . $app->website . "/JadwalAll/index?message=" . implode('<br>', $message));
    }
    ...
    public function findAll()
    {
        ...
        $sql = "SELECT CONCAT(c.name ,' - ',tc.name) as matkul, d.name as dosen, c.credit_unit as sks, c.code as kode, r.name as ruang, t.day_name as hari, DATE_FORMAT(t.start_time,'%H:%i') as masuk, DATE_FORMAT(max(t.end_time),'%H:%i') as keluar
...
class ViewJadwalAll extends View
{
    public function entry($result)
    {
        global $app;
        ?>
    <form action="<?php echo $app->website; ?>/JadwalAll/save" method="POST">
